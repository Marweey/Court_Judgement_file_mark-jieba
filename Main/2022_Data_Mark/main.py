...
jieba.load_userdict(r'E:\PC\Lib\site-packages\jieba\selfdic.txt')
...
if __name__ == '__main__':
    ...
    with open(r"..\txt\文书\目录清单.txt", "r", encoding='gbk') as f:
        names = f.read().split('\n')
    ...
    for name in names:
        ...
        with open(path + '\\' + name + '.txt', encoding='gb18030') as f:  # 打开新的文本
            strs = f.read()  # 读取文本数据
        ...
        json_data = open('../2022_Data_Mark/marked_data.json', "a+")
